# core/enhanced_workflow_engine.py - COMPLETE WORKING FILE with Role-Based LLM
...
from core.workflow_services import EnhancedPlannerService, EnhancedCoderService  # , WorkflowOrchestrator
...
"""
    ...
    async def _call_llm_async(self, prompt: str, role: LLMRole, agent_name_for_log: str, indent_level: int) -> str:
        ...
        try:
            ...
            for chunk_idx, chunk in enumerate(stream_generator):
